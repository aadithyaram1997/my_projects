/**
 * An RFID tag must be placed in front 
 * of the correct PN5180 RFID readers in order to be detected 
 */
...
// Check whether all PN5180s have detected the correct tag when using multiple sensors
