...
class ClassicalWashout:
    ...
    def process(self, accel_data, rotational_data):
        ...
        scaled_ay_lp = accel_data['y'] * self.scale_x_hp
        ...
        highpass_accel_x_2 = butter_filter(highpass_accel_x, self.hp_acc_x_1, self.fs, order=2, filter_type='high')
        highpass_accel_y_2 = butter_filter(highpass_accel_y, self.hp_acc_x_1, self.fs, order=2, filter_type='high')
        highpass_accel_z_2 = butter_filter(highpass_accel_z, self.hp_acc_x_1, self.fs, order=2, filter_type='high')
        ...
        lowpass_accel_y = butter_filter(tilt_y, self.lp_acc_x, self.fs, self.order, 'low')
        ...
        scaled_pitch = rotational_data['pitch'] * self.scale_a_hp
        scaled_yaw = rotational_data['yaw'] * self.scale_a_hp

        highpass_roll = butter_filter(scaled_roll, self.hp_roll_1, self.fs, order=1, filter_type='high')
        highpass_pitch = butter_filter(scaled_pitch, self.hp_roll_1, self.fs, order=1, filter_type='high')
        highpass_yaw = butter_filter(scaled_yaw, self.hp_roll_1, self.fs, order=1, filter_type='high')

        highpass_roll_2 = butter_filter(highpass_roll, self.hp_roll_1, self.fs, order=2, filter_type='high')
        highpass_pitch_2 = butter_filter(highpass_pitch, self.hp_roll_1, self.fs, order=2, filter_type='high')
        highpass_yaw_2 = butter_filter(highpass_yaw, self.hp_roll_1, self.fs, order=2, filter_type='high')
        ...
        pitch_angle = washout_pitch * np.exp(-self.washout_damping_a * np.arange(len(washout_pitch)) / self.fs)
        yaw_angle = washout_yaw * np.exp(-self.washout_damping_a * np.arange(len(washout_yaw)) / self.fs)
