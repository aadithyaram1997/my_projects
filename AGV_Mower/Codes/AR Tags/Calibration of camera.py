...
images = glob.glob(r"C:\Users\aadit\OneDrive\Desktop\chessboard_calib\*.png") #change this according to the path of the images for calibration
...
cv_file = cv2.FileStorage(r"C:\Users\aadit\OneDrive\Desktop\chessboard_calib\hhhh.yaml", cv2.FILE_STORAGE_WRITE)
