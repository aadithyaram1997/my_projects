...
def plot_force_distribution(data):
    ...
    fig.suptitle('Force Distribution Across the trajectory')
           ...
           # try:
            ...
            # Write all 8 force distribution values to the output CSV
                writer.writerow(force_distribution)
                   ...
                   writer.writerow([0] * 8) 
                   print(f"The pose x={x}, y={y}, z={z}, roll={roll}, pitch={pitch}, yaw={yaw} is not feasible.")  #prints the values of the rows where IRobot.getForceDistribution() returns false
