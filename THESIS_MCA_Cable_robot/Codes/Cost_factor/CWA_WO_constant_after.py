...
if __name__ == "__main__":
    ...
    force_x_factor = (((force_x_post) + Force_offset)/(((force_x)) + Force_offset))
    force_y_factor = (((force_y_post) + Force_offset)/(((force_y)) + Force_offset))
    force_z_factor = (((force_z_post) + Force_offset)/(((force_z)) + Force_offset))
