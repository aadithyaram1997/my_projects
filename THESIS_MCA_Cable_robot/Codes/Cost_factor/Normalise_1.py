...
def optimize_damping(washout_algorithm, accel_data, time):
    ...
    result_y = minimize(cost_y, [washout_algorithm.washout_damping_y], args=(washout_algorithm, accel_data, time), bounds=[(0.00000, 0.01)])
    ...
    result_z = minimize(cost_z, [washout_algorithm.washout_damping_z], args=(washout_algorithm, accel_data, time), bounds=[(0.00000, 0.01)])
